...
class UserTest {
    ...
    @Test
    @DisplayName("User should have an Id")
    ...
    @Test
    @DisplayName("User should have an github username")
    void userShouldHaveGithub_username(){
        User user = new User();
    ...
    @Test
    @DisplayName("User can have an Role as USER")
